            ...
            <div className="container-custom relative z-10 text-center">
                ...
                >
                    <motion.span
                        ...
                        whileInView={{ opacity: 0.3, tracking: '0.2em' }}
                        transition={{ duration: 0.8 }}
                        className="text-white text-[9px] md:text-xs font-bold uppercase mb-8 md:mb-12 block"
                    >
                    ...
                    <div className="relative">
                        <motion.div
                            className="bg-white/[0.02] backdrop-blur-xl border border-white/5 p-6 md:p-20 rounded-[32px] md:rounded-[64px] relative group overflow-hidden shadow-2xl shadow-black/50"
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="flex flex-col md:flex-row justify-between items-center gap-10 md:gap-12 border-t border-white/5 pt-10 md:pt-12 relative z-10"
                            >
                                ...
                                <motion.a
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="flex items-center gap-4 md:gap-6 bg-white text-black pl-6 md:pl-8 pr-1.5 md:pr-2 py-1.5 md:py-2 rounded-full font-black text-[10px] md:text-xs uppercase tracking-[0.2em] group/btn hover:bg-growaz-orange hover:text-white transition-all duration-300 shadow-xl shadow-white/5 w-full md:w-auto justify-center md:justify-start"
                                >
                                    Work With Us
                                    <div className="w-10 h-10 md:w-12 md:h-12 bg-black/5 rounded-full flex items-center justify-center group-hover/btn:bg-white group-hover/btn:text-black transition-all">
