...
const WhyUs = () => {
    return (
        <section className="py-40 bg-bg-dark text-white relative overflow-hidden border-t border-white/5">
            <div className="container-custom relative z-10">
                <div className="flex flex-col md:flex-row items-center justify-between mb-16 md:mb-24 text-center md:text-left gap-10">
                    <motion.div
                        ...
                        className="max-w-2xl"
                    >
                        <span className="text-white/40 text-xs font-bold uppercase tracking-[0.4em] mb-6 block">Why Partner With Us</span>
                        <h2 className="text-5xl md:text-7xl font-heading font-black leading-[1] tracking-tighter">
                            Engineering <br />
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <div className="flex items-center gap-4 bg-white/5 border border-white/10 px-6 py-3 md:px-8 md:py-4 rounded-full backdrop-blur-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
                    {reasons.map((reason, index) => (
                        <motion.div
                            ...
                            className="relative p-8 md:p-12 rounded-[32px] md:rounded-[52px] bg-white/[0.01] border border-white/5 hover:border-white/10 hover:bg-white/[0.03] transition-all duration-500 group overflow-hidden"
                        >
                            {/* Card Glow */}
                            <div className={`absolute top-0 right-0 w-32 h-32 ${reason.glow} blur-[60px] rounded-full pointer-events-none`} />

                            <div className={`w-14 h-14 md:w-16 md:h-16 ${reason.color} border rounded-[18px] md:rounded-2xl flex items-center justify-center mb-8 md:mb-10 group-hover:scale-110 transition-transform duration-500 shadow-2xl`}>
                                {reason.icon}
                            </div>

                            <h3 className="text-2xl font-heading font-black mb-4 md:mb-6 tracking-tight group-hover:text-white transition-colors">{reason.title}</h3>
